...
fn parse_class_var_dec(tokens : &Vec<Token>, i : &mut usize) -> Result<Option<String>, &'static str> {
...
fn parse_subroutine_dec(tokens : &Vec<Token>, i : &mut usize) -> Result<Option<String>, &'static str> {
...
fn parse_subroutine_body(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<Option<String>, &'static str> {
    let mut output = "".to_string();
    match &tokens[*i] {
        Token::Keyword(kw) => {
            if kw == "let" {
...
fn parse_let_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_if_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_while_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_do_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_return_statement(tokens : &Vec<Token>, i : &mut usize) -> Result<String, &'static str> {
...
fn parse_expression(tokens : &Vec<Token>, i : &mut usize, indent : usize) -> Result<String, &'static str> {
